...
@ResourceDependencies({
    ...
    @ResourceDependency(library = "katfaces", name = "countdown.js"),
    @ResourceDependency(library = "katfaces", name = "kkcountdown.js"),
...
public class CountDown extends UIInput implements Widget, ClientBehaviorHolder {
    ...
    public static final String COMPONENT_TYPE = "it.katfaces.CountDown";
    public static final String COMPONENT_FAMILY = "it.katfaces.components";
