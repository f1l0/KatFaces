package it.katfaces.dockablepanel;
...
@ResourceDependencies({
    ...
    @ResourceDependency(library = "katfaces", name = "dockablepanel.js"),
...
public class DockablePanel extends UIInput implements Widget, ClientBehaviorHolder {
    ...
    public static final String COMPONENT_TYPE = "it.katfaces.DockablePanel";
